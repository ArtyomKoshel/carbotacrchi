...
class LotRepository:
    ...
    def upsert_batch(self, lots: list[CarLot], stats: dict | None = None) -> int:
        ...
        sql = """
            INSERT INTO lots (
                id, source, make, model, model_en, model_group, generation, variant,
                ...
                %(trim)s, %(trim_en)s, %(package)s, %(badge)s,
                ...
                variant=COALESCE(VALUES(variant), variant),
                ...
                `package`=COALESCE(VALUES(`package`), `package`),
